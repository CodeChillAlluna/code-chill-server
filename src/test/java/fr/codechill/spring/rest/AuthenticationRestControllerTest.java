...
public class AuthenticationRestControllerTest {
  ...
  public void successfulAuthenticationWithAnonymousUser() throws Exception {
    ...
    JwtAuthenticationRequest jwtAuthenticationRequest =
        new JwtAuthenticationRequest("user", "password");
  ...
  public void successfulRefreshTokenWithUserRole() throws Exception {
    ...
    this.mvc
        .perform(
            get("/refresh").header("Authorization", "Bearer 5d1103e-b3e1-4ae9-b606-46c9c1bc915a"))
        .andExpect(status().is2xxSuccessful());
  }
  ...
  public void testRefreshWrongToken() throws Exception {
    this.mvc
        .perform(get("/refresh").header("Authorization", "Bearer cjeoenvoeve"))
